...
### <span id="head2">2. 深度优先遍历</span>

#### <span id="head3">2.1 递归方式</span>
...
### <span id="head6">4. 案例</span>

#### <span id="head7">4.1 二叉树的最大深度</span>
...
#### <span id="head8">4.2 记录每一层的所有元素</span>
